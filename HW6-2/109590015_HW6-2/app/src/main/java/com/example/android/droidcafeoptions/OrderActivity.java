...
public class OrderActivity extends AppCompatActivity {
    ...
    /**
     * Checks which radio button_Date was clicked and displays a toast message to
     * show the choice.
     *
     * @param view The radio button_Date view.
     */
    public void onRadioButtonClicked(View view) {
        // Is the button_Date now checked?
        boolean checked = ((RadioButton) view).isChecked();
        // Check which radio button_Date was clicked.
        switch (view.getId()) {
            case R.id.sameday:
                if (checked)
                    // Same day service
