...
/**
 * This app demonstrates images used as buttons and a floating action button_Date to
...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * Creates the content view, the toolbar, and the floating action button_Date.
