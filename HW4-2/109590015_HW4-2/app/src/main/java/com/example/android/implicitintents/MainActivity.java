...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * Handles the onClick for the "Open Website" button_takePicture. Gets the URI
    ...
    /**
     * Handles the onClick for the "Open Location" button_takePicture. Gets the location
    ...
    /**
     * Handles the onClick for the "Share This Text" button_takePicture. The
    ...
    public void Button_takePicture_onClick(View View) {
